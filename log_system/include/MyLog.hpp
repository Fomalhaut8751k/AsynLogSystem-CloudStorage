...
//     // 简化用户使用，宏函数默认填上文件+行号
//     #define Debug(fmt, ...) Debug(__FILE__, __LINE__, fmt, ##__VA_ARFS__);
//     #define Info(fmt, ...) Info(__FILE__, __LINE__, fmt, ##__VA_ARFS__);
//     #define Warn(fmt, ...) Warn(__FILE__, __LINE__, fmt, ##__VA_ARFS__);
//     #define Error(fmt, ...) Error(__FILE__, __LINE__, fmt, ##__VA_ARFS__);
//     #define Fatal(fmt, ...) Fatal(__FILE__, __LINE__, fmt, ##__VA_ARFS__);
